...
def send_message(coupon_doc):
    ...
    cleaned_mobile = coupon_doc.receiver_mobile
                ...
                "components": [
                    ...
                    },
                    {
                        ...
                        "parameters": [
                            {
                                "type": "text",
                                "text": getdate(coupon_doc.use_date).strftime(
                                    "%d %B, %Y"
                                ),
                            },
                            {"type": "text", "text": coupon_doc.slot},
                            {"type": "text", "text": coupon_doc.number},
                            {"type": "text", "text": coupon_doc.venue},
                        ],
                    },
                ],
            },
